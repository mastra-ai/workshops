...
const Title: Page = () => (
  ...
  >
    ...
    >
      Turning what your agent already emits into a map of what it actually does.
    </p>
    ...
    >
      Eric Pinzur <span style={{ color: palette.dim }}>·</span> Daniel Lew
    </div>
  </div>
);
  ...
  >
    ...
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 32, marginTop: 56 }}>
      ...
      >
        ...
        <p style={{ fontSize: 34, lineHeight: 1.2, margin: 0, fontWeight: 500, color: palette.textSoft }}>
          Principal Engineer, <span style={{ color: 'var(--osd-accent)' }}>Mastra</span>
        </p>
      </div>
      ...
      >
        ...
        <p style={{ fontSize: 34, lineHeight: 1.2, margin: 0, fontWeight: 500, color: palette.textSoft }}>
          Software Engineer, <span style={{ color: 'var(--osd-accent)' }}>Mastra</span>
        </p>
        <div
          style={{
            marginTop: 32,
        ...
        >
          <Handle label="X" value="@shlomeslew" />
        </div>
      </div>
      ...
      >
        ...
        <p style={{ fontSize: 34, lineHeight: 1.2, margin: 0, fontWeight: 500, color: palette.textSoft }}>
          Head of DX, <span style={{ color: 'var(--osd-accent)' }}>Mastra</span>
        </p>
        <div
          style={{
            marginTop: 32,
        ...
        >
          <Handle label="X" value="@bookercodes" />
        </div>
      </div>
    </div>
  </div>
...
const DiscoveryCard = ({
  ...
  <div
    style={{
      ...
      borderRadius: 'var(--osd-radius)',
      background: accent
        ? 'linear-gradient(155deg, rgba(139,127,245,0.16) 0%, #12121a 58%)'
        : palette.surface,
      border: `1px solid ${accent ? '#8b7ff566' : palette.border}`,
      boxSizing: 'border-box',
      display: 'flex',
      flexDirection: 'column',
    }}
  >
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
      ...
      <div style={{ fontFamily: font.mono, fontSize: 20, color: palette.muted }}>{index}</div>
    </div>
    <div
      style={{
        marginTop: 52,
...
const BehaviorDiscovery: Page = () => (
  <div style={fill}>
    ...
    >
      Your users won&apos;t tell you
      <br />
      <span style={{ color: 'var(--osd-accent)' }}>everything your agent is doing.</span>
    </h2>

    <div style={{ position: 'absolute', top: 230, left: 236, fontSize: 34, color: palette.textSoft }}>
      Trace intelligence reveals the issues, behaviors, and interactions that never become explicit feedback.
    </div>
    ...
    >
      <DiscoveryCard
        index="01"
        label="Hidden issues"
        note="Repeated retries, partial completions, abandonment, and quiet workarounds."
      >
        Failures that never become support tickets.
      </DiscoveryCard>
      <DiscoveryCard
        index="02"
        label="Unexpected behavior"
        note="New use cases, unplanned workflows, and surprising paths through tools."
      >
        Patterns you never designed or instrumented for.
      </DiscoveryCard>
      <DiscoveryCard
        index="03"
        label="Real interactions"
        note="What users want, how the agent responds, and where the interaction changes."
        accent
      >
        How people actually work with your agent.
      </DiscoveryCard>
    </div>
    ...
    >
      Understand your agent through <span style={{ color: 'var(--osd-accent)' }}>what it does—not only what users report.</span>
    </div>
  </div>
);
...
const ThemeCard = ({
  ...
  >
    ...
    <div>
      <div style={{ fontSize: 42, fontWeight: 600, color, letterSpacing: '-0.02em' }}>{title}</div>
      <div style={{ fontSize: 30, color: palette.textSoft, marginTop: 8 }}>({count} trace signals)</div>
    </div>
  </div>
);
...
const PIPE = {
  bands: [
    ...
    { x: 1310, w: 510, label: 'Trace Signal Generation', how: 'model', tone: '#8b7ff5' },
  ],
  chipX: 800,
  chipW: 330,
  chipH: 76,
...
const SignalEvidenceRow = ({ label, value, color }: { label: string; value: string; color: string }) => (
  <div
    style={{
      padding: '8px 14px',
      borderRadius: 10,
  ...
  >
    <div style={{ fontFamily: font.mono, fontSize: 16, letterSpacing: '0.1em', textTransform: 'uppercase', color }}>
      {label}
    </div>
    <div style={{ marginTop: 3, fontSize: 21, lineHeight: 1.2, color: palette.textSoft }}>{value}</div>
  </div>
);

const SignalGeneration: Page = () => (
  <div style={fill}>
    <PageNumber />
    <PageHead title="Trace signal generation" sub="Feature-creation outputs become evidence for one compact AI summary." />

    <Backdrop cx={960} cy={540} rx={840} ry={360} />

    <svg width={1920} height={1080} viewBox="0 0 1920 1080" aria-hidden style={{ position: 'absolute', inset: 0 }}>
      <FlowArrow d="M 640 548 H 804" head={[814, 548]} color={palette.muted} />
      <FlowArrow d="M 1086 548 H 1190" head={[1200, 548]} color={`${palette.accent}b3`} />
    </svg>
    ...
    >
      <div style={{ fontFamily: font.mono, fontSize: 22, letterSpacing: '0.16em', textTransform: 'uppercase', color: palette.blue }}>
        Prepared evidence
      </div>
      <div style={{ marginTop: 24, display: 'flex', flexDirection: 'column', gap: 10 }}>
        <SignalEvidenceRow label="Deterministic tags" value="Tool error + repeated retry" color={palette.green} />
        <SignalEvidenceRow label="Sentiment history" value="Neutral → frustrated" color={palette.orange} />
        <SignalEvidenceRow label="Last user input" value="“Send me the weekly report”" color={palette.blue} />
        <SignalEvidenceRow label="Observational summary" value="Export timed out twice" color={palette.textSoft} />
        <SignalEvidenceRow label="Intent summary" value="Generate and deliver reports" color={palette.accent} />
      </div>
    </div>
    ...
    <div
      style={{
        ...
        background: `radial-gradient(circle at 40% 35%, ${palette.accent}30 0%, ${palette.surface} 72%)`,
        boxShadow: `0 0 64px ${palette.accent}26`,
        display: 'flex',
        flexDirection: 'column',
        alignItems: 'center',
        justifyContent: 'center',
    ...
    >
      <Sparkle size={48} />
      <div style={{ fontFamily: font.mono, fontSize: 24, letterSpacing: '0.14em', textTransform: 'uppercase' }}>AI</div>
    </div>
    ...
    <div
      style={{
        ...
        background: `linear-gradient(145deg, ${palette.accent}18 0%, ${palette.surface} 72%)`,
        boxShadow: `0 24px 64px -34px ${palette.accent}80`,
      }}
    >
      <div style={{ fontFamily: font.mono, fontSize: 22, letterSpacing: '0.16em', textTransform: 'uppercase', color: 'var(--osd-accent)' }}>
        Compact behavior trace signal
      </div>
      <div style={{ marginTop: 42, fontSize: 42, lineHeight: 1.4, fontWeight: 500, letterSpacing: '-0.015em' }}>
        “Retries report export after repeated tool timeouts.”
      </div>
    </div>

    <Takeaway>
      Preserve what matters.{' '}
      <span style={{ color: 'var(--osd-accent)' }}>Drop the trace noise.</span>
    </Takeaway>
  </div>
);
...
const Themes: Page = () => (
  <div style={fill}>
    ...
    >
      AI labels and describes groupings
    </h2>
...
const ThemeMath: Page = () => {
  ...
  return (
    <div style={fill}>
      ...
      >
        Per trace signal. Every trace signal type gets its own space.
      </div>
...
const LivingModel: Page = () => (
  <div style={fill}>
    ...
    <div style={{ position: 'absolute', top: 138, left: 236, fontSize: 40, color: palette.textSoft }}>
      Themes can be <span style={{ color: 'var(--osd-accent)' }}>born, continue, split, merge, die, or resurrect.</span>
    </div>
...
const Struggle: Page = () => (
  <div style={fill}>
    <PageNumber />
    <PageHead title="Traces show what happened." sub="They don’t tell you what it means." />
    ...
    <svg width={1920} height={1080} viewBox="0 0 1920 1080" aria-hidden style={{ position: 'absolute', inset: 0 }}>
      ...
      <FlowArrow d="M 470 557 H 570" head={[580, 557]} color="#3b3b4c" />
      <FlowArrow d="M 1200 557 H 1296" head={[1306, 557]} color={`${palette.accent}a6`} />
    </svg>

    <FlowNode x={170} y={467} w={300} h={180} title="Raw traces" lines={['Events, spans, and outcomes']} tone="dim" size={34} />
    ...
    <FlowNode x={1320} y={467} w={400} h={180} title="Behavioral map" lines={['What the agent actually does']} tone="accent" size={34} />

    <Takeaway>
      The gap isn&apos;t between telemetry and a better agent.{' '}
      <span style={{ color: 'var(--osd-accent)' }}>It&apos;s between telemetry and understanding.</span>
    </Takeaway>
  </div>
);
...
const ROADMAP = [
  { title: 'Traces', lines: ['What the agent', 'emitted'] },
  { title: 'Trace signals', lines: ['What happened', 'inside each trace'] },
  { title: 'Themes', lines: ['Which behaviors', 'repeat'] },
  { title: 'Evolution', lines: ['How behaviors', 'change over time'] },
  { title: 'Investigation', lines: ['Why the map', 'changed'] },
  { title: 'Action', lines: ['What to do with', 'that understanding'] },
];
...
const RM_ACTS = [
  { label: 'Trace Intelligence', from: 0, to: 3, t: 0.85 },
  { label: 'Investigation', from: 4, to: 4, t: 0 },
  { label: 'Action', from: 5, to: 5, t: 0 },
];
...
const Roadmap: Page = () => (
  <div style={fill}>
    <PageNumber />
    <PageHead title="The agent learning loop" sub="Today: the trace intelligence half—from trace stream to behavioral map." />

    <Backdrop cx={960} cy={520} rx={900} ry={360} />
    <Backdrop cx={rmCx(2)} cy={rmMid} rx={620} ry={250} />

    <svg width={1920} height={1080} viewBox="0 0 1920 1080" aria-hidden style={{ position: 'absolute', inset: 0 }}>
      <defs>
        <linearGradient id="rm-spine" x1="0" x2="1" y1="0" y2="0">
          <stop offset="0%" stopColor="#33334a" />
          <stop offset="60%" stopColor={palette.accent} />
          <stop offset="68%" stopColor="#22222e" />
      ...
      {ROADMAP.slice(0, -1).map((stage, i) => (
        <path
          ...
          fill={mix('#3a3a4c', palette.accent, i < 3 ? (i + 1) / 3 : 0)}
        />
      ))}
    ...
    {ROADMAP.map((stage, i) => {
      const focused = i <= 3;
      const t = focused ? i / 3 : 0;
      const last = i === 3;
      return (
        <div key={stage.title} style={{ opacity: focused ? 1 : 0.28 }}>
          <div
            style={{
              position: 'absolute',
              left: rmX(i),
    ...
    <EdgeChip x={960} y={rmBottom + 175} color={palette.accent}>
      The full agent learning loop continues
    </EdgeChip>

    <Takeaway>
      Today, we stay with the map:{' '}
      <span style={{ color: 'var(--osd-accent)' }}>traces → trace signals → themes → evolution.</span>
    </Takeaway>
  </div>
);
...
const TraceIntelligence: Page = () => (
  <ActDivider
    ...
    sub="Extract trace signals from every trace, organize them into themes, and watch the behavioral map evolve."
    lit={[0, 3]}
  />
);
...
const Validation: Page = () => (
  <div style={fill}>
    ...
    <DecisionFlow
      ...
      reject={{ label: 'No', title: 'Return for revision', lines: ['The result missed the bar'] }}
...
const Deployment: Page = () => (
  <div style={fill}>
    ...
    <DecisionFlow
      ...
      reject={{ label: 'Found', title: 'Return for revision', lines: ['The broader suite regressed'] }}
...
// ────────────────────────────────────────────────────────────────────────────
// Proof — the deck is called Trace Intelligence, so a number has to move. The bug
...
const LOOP_STAGES = ['Traces', 'Trace signals', 'Themes', 'Candidate', 'Investigation', 'Pull request'];
...
const Sankey: Page = () => (
  <div style={fill}>
    ...
    >
      Every trace connects across trace signals.
    </h2>
    <div
      style={{
        position: 'absolute',
    ...
    >
      Each column is a trace signal. Each block is a theme inside it.
    </div>
    ...
    >
      Each line is one trace threading through its trace signals.
    </div>
    <div
      style={{
        position: 'absolute',
...
// ────────────────────────────────────────────────────────────────────────────
// Thank you — presenters, community, and the next workshop.

const ThankYou: Page = () => (
  <div style={fill}>
    <PageNumber />
    <Backdrop cx={1460} cy={450} rx={520} ry={430} />
    ...
    <div style={{ position: 'absolute', left: 148, top: 294, fontSize: 32, color: palette.textSoft }}>
      Eric Pinzur · Daniel Lew · Alex Booker
    </div>
    ...
    >
      ...
      >
        <div style={{ fontFamily: font.mono, fontSize: 22, letterSpacing: '0.16em', color: palette.muted, textTransform: 'uppercase' }}>
          Join the community
        </div>
        <div style={{ marginTop: 34, fontSize: 46, fontWeight: 700, letterSpacing: '-0.025em' }}>discord.gg/mastra</div>
        <div style={{ marginTop: 20, fontSize: 28, color: palette.textSoft }}>Ask questions, share projects, and keep the conversation going.</div>
      </a>
