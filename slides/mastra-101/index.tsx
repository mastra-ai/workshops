...
const MasterclassFlow: Page = () => (
  <Stage index={32}>
    ...
    <div style={{ marginTop: 48, display: 'flex', gap: 28, fontFamily: font.mono, fontSize: 22 }}>
      <span style={{ color: palette.accent }}>mastra-101</span>
...
export const notes: (string | undefined)[] = [
  ...
  // 32 Masterclass flow
  `Close by turning the slide into an action plan. Do not build the whole architecture on day one. Start with one narrow agent and one useful workflow through Studio. Add tools when the agent needs hands, add memory and RAG when context matters, promote business rules into workflows, add processors when prompts are carrying enforcement work, and add observability before launch. Point people to mastra-101, mastra.ai, GitHub, and Discord. Invite questions framed around decomposition: "Tell me one agent you are building, and we can decide which primitive should own each responsibility."`,
];
