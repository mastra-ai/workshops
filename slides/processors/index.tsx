    ...
    <div style={{ marginTop: 40, display: 'grid', gridTemplateColumns: '1fr 1.4fr', gap: 28 }}>
      ...
      >
        ...
        >
          ...
          <div>cd guardrails &amp;&amp; <span style={{ color: palette.accent }}>PORT=4111 mastra dev</span></div>
          <div>cd beyond-guardrails &amp;&amp; <span style={{ color: palette.accent }}>PORT=4112 mastra dev</span></div>
          <div>cd enterprise-pipeline &amp;&amp; <span style={{ color: palette.accent }}>PORT=4113 mastra dev</span></div>
        </div>
