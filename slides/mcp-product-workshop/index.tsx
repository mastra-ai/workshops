...
export const notes: (string | undefined)[] = [
  ...
  'Both Mastra workshops were called Build an MCP Server with Mastra, on June 12, 2025 and September 4, 2025. Selected MCP milestones: November 2024 launch, March 2025 Streamable HTTP, December 9, 2025 AAIF donation, July 28, 2026 stateless revision. June 18, 2025 also added structured outputs and elicitation; mention only if helpful. Primary references in docs/sources.md. The schema date 2024-11-05 is not the public announcement date.',
