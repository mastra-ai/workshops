...
Repository layout override: deck paths remain `slides/<id>/`, while shared OpenSlide paths are under that project folder. Read `themes/` as `slides/themes/` and root `assets/` as `slides/assets/`.
